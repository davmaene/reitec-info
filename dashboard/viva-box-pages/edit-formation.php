<?php 
    ...
    if(isset($_GET['_elem']) && is_numeric($_GET['_elem'])){
        $element = $_GET['_elem'];
        $elem = (getFormationById($g,$element)[0]);
        // var_dump($elem);
        if($elem === 0){
?>
    <script>
                    ...
                    <div class="card-body">
                        <form id="form-addCours">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nom-cnnx" name="titre_cnnx" value="<?php echo($elem->titre) ?>" class="form-control font-weight-bold" placeholder="entrer votre nom ... ">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="date-s-cnnx" name="date_s_cnnx" class="form-control" value="<?php echo($elem->date_s) ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="date-e-cnnx">Date de la fin</label>
                                            <input type="date" name="date_e_cnnx" id="date-e-cnnx" class="form-control" value="<?php echo($elem->date_e) ?>" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="pst-cnnx" name="prix_cnnx" class="form-control font-weight-bold" value="<?php echo($elem->prix) ?>" placeholder="entrer le prix de la formation">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" id="desc-cnnx" name="desc_cnnx" class="form-control" placeholder="entrer description">
                                    <?php echo($elem->description) ?>
                                </textarea>
                                <b id="desc_cnnx" class="text-danger d-none"><span class="fa fa-warning"></span> La synthese du cours doit être un text </b>
                            </div>
                            <div class="form-group">
                                ...
                                <b id="prix_cnnx" class="text-danger d-none"><span class="fa fa-warning"></span> Selectionner un facilitateur </b>
                            </div>
...
<script>
    ...
    let isFile = function(e){
        ...
        image_holder.empty();
        // extn == "doc" || extn == "ppt" || || extn == "docx" || extn == "xlsx" || extn == "xls"
        if (extn === "pdf") {
    ...
    $('#form-addCours').on('submit', function(e){
        ...
        if(canAdd()){
            ...
            if($('#crskind').attr('type') !== 'text'){
                ...
                xhr.open('POST', `viva-box-scripts/php/reqxhr.php?cbad=edit&item=${indead}`,true);
                xhr.onreadystatechange = function(){
                    if(xhr.readyState === 4 && xhr.status === 200){
