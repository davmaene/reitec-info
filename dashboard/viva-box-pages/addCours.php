                ...
                <div class="card card-outline card-primary">
                    <div class="card-header border-bottom-0">
                        <div class="card-title">
                            <h4 class="mb-2 text-prmy">Add a new Cours</h4>
                            <p>Add a new Cours and attribute him to a facilitator</p>
                        </div>
                    </div>
                    <div class="card-body">
                        <form id="form-addCours">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="delais-cnnx" name="delais_cnnx" class="form-control" placeholder="entrer votre post nom ... ">
                                <b id="delais_cnnx" class="text-danger d-none"><span class="fa fa-warning"></span> Le delais entrer n'est pas valide ex : 48 sans symbole </b>
                            </div>
                            <div class="form-group">
                                <label for="pst-cnnx">Prix de la formation <span class="text-danger">*</span></label>
                                <input type="text" id="pst-cnnx" name="prix_cnnx" class="form-control" placeholder="entrer votre post nom ... ">
                            ...
                            <div class="form-group">
                                <label for="desc-cnnx">Description du cours <span class="text-danger">*</span></label>
...
<script>
    ...
    const canAdd = function(){
        ...
        return _kind() && _tit() && _delais() && _prx() && _categ() && _subcateg();
    }
