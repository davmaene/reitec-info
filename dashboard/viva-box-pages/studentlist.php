...
<section>
    <div class="container">
        <h3 class="text-primary"><span class="fas fa-chevron-right mr-2"></span>Student</h3>
        <div class="col-lg-12 my-2 border p-1 rounded">
            <a href="?page=addStudent" class="btn btn-primary btn-sm" id="add-facilitator">
                Add new Student
            </a>
        </div>
        <div class="card card-outline card-primary">
            <div class="card-header">
                <h5>Listing of Students</h5>
